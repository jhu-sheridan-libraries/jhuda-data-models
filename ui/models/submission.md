...
| [status](#submission-status) | enum | An overview of the current overall status of the submission. |
| [metadataStatus](#metadata-status) | enum | Status describing the current state of the submission metadata. |
| [filesStatus](#files-status) | enum | This status summarizes the state of the files associated with this submission. |
...
| pendingReview | Submission metadata or files are pending review. |
